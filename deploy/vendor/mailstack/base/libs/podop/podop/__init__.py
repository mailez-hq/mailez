...
It is able to proxify legacy MTA maps and legacy IMAP dicts to any table
"""
...
from podop import legacy MTA, legacy IMAP, table


SERVER_TYPES = dict(
    legacy MTA=postfix.SocketmapProtocol,
    legacy IMAP=dovecot.DictProtocol
)
