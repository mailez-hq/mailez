""" legacy MTA map proxy implementation
"""
...
class SocketmapProtocol(NetstringProtocol):
    """ Protocol to answer legacy MTA socketmap and proxify lookups to
    an outside object.
    ...
    def string_received(self, string):
        # The legacy MTA format contains a space for separating the map name and
        # the key
