""" legacy IMAP dict proxy implementation
"""
...
class DictProtocol(asyncio.Protocol):
    """ Protocol to answer legacy IMAP dict requests, as implemented in Dict proxy.
    ...
    https://github.com/legacy IMAP/core/blob/master/src/dict/dict-connection.c
    https://github.com/legacy IMAP/core/blob/master/src/dict/dict-commands.c
    https://github.com/legacy IMAP/core/blob/master/src/lib-dict/dict-client.h
    """
    ...
    def __init__(self, table_map):
        ...
        # Every connection starts with specifying which table is used, legacy IMAP
...
def tabescape(unescaped):
    """ Escape a string using the specific legacy IMAP tabescape
    See: https://github.com/legacy IMAP/core/blob/master/src/lib/strescape.c
    """
...
def tabunescape(escaped):
    """ Unescape a string using the specific legacy IMAP tabescape
    See: https://github.com/legacy IMAP/core/blob/master/src/lib/strescape.c
    """
