...
args["TLS"] = {
    ...
    "letsencrypt": ("/certs/letsencrypt/live/mailez/nginx-chain.pem",
        "/certs/letsencrypt/live/mailez/privkey.pem", "/certs/letsencrypt/live/mailez-ecdsa/nginx-chain.pem", "/certs/letsencrypt/live/mailez-ecdsa/privkey.pem"),
    "mail": ("/certs/%s" % cert_name, "/certs/%s" % keypair_name),
    "mail-letsencrypt": ("/certs/letsencrypt/live/mailez/nginx-chain.pem",
        "/certs/letsencrypt/live/mailez/privkey.pem", "/certs/letsencrypt/live/mailez-ecdsa/nginx-chain.pem", "/certs/letsencrypt/live/mailez-ecdsa/privkey.pem"),
    "notls": None
}[args["TLS_FLAVOR"]]
...
if args['TLS_FLAVOR'] in ['letsencrypt', 'mail-letsencrypt']:
    format_for_nginx('/certs/letsencrypt/live/mailez/fullchain.pem', '/certs/letsencrypt/live/mailez/nginx-chain.pem')
    format_for_nginx('/certs/letsencrypt/live/mailez/fullchain.pem', '/certs/letsencrypt/live/mailez/DANE-chain.pem', False)
    format_for_nginx('/certs/letsencrypt/live/mailez-ecdsa/fullchain.pem', '/certs/letsencrypt/live/mailez-ecdsa/nginx-chain.pem')
    format_for_nginx('/certs/letsencrypt/live/mailez-ecdsa/fullchain.pem', '/certs/letsencrypt/live/mailez-ecdsa/DANE-chain.pem', False)
...
conf.jinja("/dovecot_conf/login.lua", args, "/etc/legacy IMAP/login.lua")
conf.jinja("/dovecot_conf/proxy.conf", args, "/etc/legacy IMAP/proxy.conf")
os.system("killall -q -HUP nginx legacy IMAP")
