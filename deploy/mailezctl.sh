#!/usr/bin/env bash
# mailezctl — management entry: dev / prod (+ optional legacy MTA/IMAP stack).
#
# Default tiers:
...
#   postdove = docker-compose.postdove.yml (MySQL control plane + legacy MTA/IMAP stack)
#
# Usage:
#   ./deploy/mailezctl.sh up              # dev
#   ./deploy/mailezctl.sh up prod         # prod
#   ./deploy/mailezctl.sh up postdove     # legacy MTA/IMAP stack prod
