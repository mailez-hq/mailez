...
Self-hosted mail stack built on proven third-party components (nginx / legacy MTA
/ legacy IMAP / Rspamd) with a fully self-developed control plane (admin, SSO,
...
- Internal API consumed by the mail stack (vendored podop bridge): legacy MTA maps,
...
self-built mail-stack images (nginx/legacy MTA/IMAP stack/rspamd, built from
