...
export function ReadingPane({
  ...
  // Inline quick reply in thread view: which member the box targets (mainstream webmail
        ...
        {isConversation && !threadForDetail ? (
          ...
          <div className="space-y-0">
            {threadMessages.map((msg, idx) => {
              // mainstream webmail model: the inline reply box lives under the message
