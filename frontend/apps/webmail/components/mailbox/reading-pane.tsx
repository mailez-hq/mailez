...
export function ReadingPane({
  ...
  // this quote" (mainstream webmail/mainstream clients 引用选中段落回复).
  useEffect(() => {
    if (!detail) return;
    const onMouseUp = () => {
  ...
  // member (mainstream webmail semantics); the AI summary covers the whole conversation.
      ...
      <div className="px-4 py-4 md:px-6">
        ...
        {isConversation && !threadForDetail ? (
          ...
          <div>
            ...
            {/* Recall notice (classic-style X-MS-Recall) */}
            <RecallNotice
              detail={detail}
              folder={folder}
