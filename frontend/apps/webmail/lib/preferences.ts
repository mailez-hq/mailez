...
// Conversation view groups the message list by thread (modern-style); turning
...
export type Preferences = {
  ...
  // compose (modern-style); off shows the full quote expanded (traditional-style).
...
// used by mainstream webmail / mainstream clients / mainstream clients).
