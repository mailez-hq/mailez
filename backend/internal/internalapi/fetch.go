...
// fetchList mirrors mainstream suite's /internal/fetch: the fetchmail poller reads the
...
// fetchDone mirrors mainstream suite's POST /internal/fetch/<id>: the poller reports the
