...
// rspamdDkimKey mirrors mainstream suite's /internal/rspamd/vault/v1/dkim/<domain>.
...
// rspamdLocalDomains mirrors mainstream suite: a plain-text, newline-separated list of
