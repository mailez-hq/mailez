// Package activesync implements the server side of ActiveSync
...
// certain third-party iOS clients/Android) can configure the account with the mailbox
...
// handleAutodiscover answers the XML autodiscover request so iOS/mainstream clients can
