...
// the community (postdove) and enterprise (mailezine) editions can carry a
// service certificate, so a free-edition customer can still buy paid
// support, SLA and launch assistance.
//
