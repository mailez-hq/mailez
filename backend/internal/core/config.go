...
// postdove = community edition (legacy MTA/IMAP stack), mailezine = enterprise
...
func Load() Config {
	cfg := Config{
		...
		DovecotAddress:       env("DOVECOT_ADDRESS", "legacy IMAP"),
		PostfixAddress:       env("POSTFIX_ADDRESS", "legacy MTA"),
