...
var migrations = []migration{
	...
	{
		// Global announcement banner (mainstream suite parity): one admin-authored notice
	...
	},
	{
		...
		// archived message store (enterprise-style 归档/检索/审查).
	...
	},
	{
		...
		// held messages awaiting approver decisions (enterprise-style 审批).
	...
	},
	{
		...
		// device/IP can raise an email alert (mainstream-style).
	...
	},
	{
		...
		// structured member list for enterprise-style group management.
