...
// DictHandler serves the legacy IMAP dict protocol over a
...
// PostfixSocketmapServe serves the legacy MTA socketmap protocol
...
// value legacy MTA expects, mirroring the reference str(json.loads(body)) behavior for
