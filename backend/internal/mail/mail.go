...
type Message struct {
	...
	// Recall is set when the message is a recall notice (classic-style
...
// ListConversationsSorted returns one page of conversations (modern-style):
...
// parseRecallNotice detects an classic-style recall notice and returns the
